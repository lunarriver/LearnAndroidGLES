...
class TwoProgramsActivity : ComponentActivity() {
    companion object {
        ...
        const val FRAGMENT_SHADER_SOURCE1 = """
        ...
        const val FRAGMENT_SHADER_SOURCE2 = """
            precision mediump float;
            void main() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        glSurfaceView.setRenderer(object : GLSurfaceView.Renderer {
            private var program1: Int = -1
            private var program2: Int = -1

            override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
                program1 = initShaderProgram(FRAGMENT_SHADER_SOURCE1)
                program2 = initShaderProgram(FRAGMENT_SHADER_SOURCE2)
            ...
            override fun onDrawFrame(gl: GL10?) {
                ...
                val aPosLocation = GLES20.glGetAttribLocation(program1, "aPos")
                ...
                // 必须重新配置
                val aPosLocationAgain = GLES20.glGetAttribLocation(program2, "aPos")
    ...
    private fun initShaderProgram(fragmentShaderSource: String): Int {
