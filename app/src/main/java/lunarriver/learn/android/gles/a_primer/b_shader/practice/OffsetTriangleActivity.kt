...
class OffsetTriangleActivity : BaseGLSurfaceActivity() {
    companion object {
        // 三角形顶点
    ...
    override fun onSurfaceCreated() {
        shaderProgram = ShaderProgram(
            this@OffsetTriangleActivity,
            "a_primer/b_shader/offset_triangle/vertex.glsl",
            "a_primer/b_shader/offset_triangle/fragment.glsl"
        )
        initVertexBuffer()
    }
