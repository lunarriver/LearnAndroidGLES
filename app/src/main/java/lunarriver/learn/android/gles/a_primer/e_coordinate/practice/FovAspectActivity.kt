...
class FovAspectActivity: BaseGLSurfaceActivity() {
    companion object {
        // 三角形顶点
    ...
    private var fov = 45f
    private var baseAspect = 1f
    private var aspect = 1f

    override fun layoutResource() = R.layout.activity_fov_aspect
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val aspectSeekBar: SeekBar = findViewById(R.id.aspectSeekBar)
        aspectSeekBar.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                aspect = baseAspect * progress.toFloat() / 50
            }
    ...
    override fun onSurfaceCreated() {
        baseAspect = getScreenAspectRatio(this)
        aspect = baseAspect

        shaderProgram = ShaderProgram(
            this@FovAspectActivity,
