...
class CameraMoveActivity: BaseGLSurfaceActivity() {
    companion object {
        // 三角形顶点
    ...
    override fun layoutResource() = R.layout.activity_camera_move
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.wTv).setOnClickListener {
            cameraPos = vec3Plus(cameraPos, vec3MultiplyNum(cameraFront, 0.2f * deltaTime))
        }
