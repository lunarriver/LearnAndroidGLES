...
class FourFaceActivity : BaseGLSurfaceActivity() {
    companion object {
        // 三角形顶点
    ...
    override fun onSurfaceCreated() {
        shaderProgram = ShaderProgram(
            this@FourFaceActivity,
            "a_primer/c_texture/face/vertex.glsl",
            "a_primer/c_texture/face/fragment.glsl"
        )
        initVertexBuffer()

        containerTexture = initTexture(GLES20.GL_CLAMP_TO_EDGE) {
...
//        faceTexture = initTexture(GLES20.GL_REPEAT) {
        faceTexture = initTexture(GLES20.GL_MIRRORED_REPEAT) {
    ...
    private fun initTexture(wrap: Int, bindData: () -> Unit): Int {
