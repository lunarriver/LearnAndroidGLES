...
class CameraActivity: BaseGLSurfaceActivity() {
    companion object {
        // 三角形顶点
    ...
    override fun layoutResource() = R.layout.activity_camera
    ...
    override fun onDrawFrame() {
        ...
        val camX = (sin(rotateAngle * PI / 180) * 10).toFloat()
        val camZ = (cos(rotateAngle * PI / 180) * 10).toFloat()
