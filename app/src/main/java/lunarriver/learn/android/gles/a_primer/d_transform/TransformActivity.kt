...
class TransformActivity: BaseGLSurfaceActivity() {
    companion object {
        // 三角形顶点
    ...
    override fun layoutResource() = R.layout.activity_transform
    ...
    override fun onDrawFrame() {
        ...
        val mat4 = generateMat4fv()
        Matrix.translateM(mat4, 0, 0.5f, -0.5f, 0f)
        Matrix.rotateM(mat4, 0, rotateAngle, 0f, 0f, 1f)
        shaderProgram.setMat4("transform", mat4)
