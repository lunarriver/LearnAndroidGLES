package lunarriver.learn.android.gles.a_primer.e_coordinate.practice
...
class ViewMatrixActivity: BaseGLSurfaceActivity() {
    companion object {
        // 三角形顶点
    ...
    private var zDiff = 0f

    override fun layoutResource() = R.layout.activity_view_matrix

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        val xDiffSeekBar: SeekBar = findViewById(R.id.xDiffSeekBar)
        xDiffSeekBar.setOnSeekBarChangeListener(object: SeekBar.OnSeekBarChangeListener {
            override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                xDiff = (progress - 50).toFloat() / 50
            }
        ...
        val yDiffSeekBar: SeekBar = findViewById(R.id.yDiffSeekBar)
        yDiffSeekBar.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                yDiff = (progress - 50).toFloat() / 50
            }
        ...
        val zDiffSeekBar: SeekBar = findViewById(R.id.zDiffSeekBar)
        zDiffSeekBar.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                zDiff = (progress - 50).toFloat() / 50
            }
    ...
    override fun onDrawFrame() {
        ...
        Matrix.rotateM(model, 0, -55f, 1f, 0f, 0f)
        shaderProgram.setMat4("model", model)
        // 观察矩阵
        val view = generateMat4fv()
        Matrix.translateM(view, 0, 0f + xDiff, 0f + yDiff, -3f + zDiff)
