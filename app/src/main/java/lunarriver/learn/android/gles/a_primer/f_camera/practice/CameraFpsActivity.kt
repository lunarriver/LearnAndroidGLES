package lunarriver.learn.android.gles.a_primer.f_camera.practice
...
import lunarriver.learn.android.gles.utils.Camera
...
class CameraFpsActivity : BaseGLSurfaceActivity() {
    companion object {
        // 三角形顶点
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        camera = Camera(this, true)
        camera.setupWithController(cameraController)
    }
